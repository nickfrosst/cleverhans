...
from cleverhans.loss import SoftNearestNeighborRegularizedCrossEntropy, CrossEntropy
...
def mnist_tutorial(train_start=0, train_end=60000, test_start=0,
  ...
  if clean_train:
    ...
    loss = SoftNearestNeighborRegularizedCrossEntropy(model, temperature=100.)
